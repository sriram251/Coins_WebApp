...
function LandingPage() {
  ...
  {/* <main id="main">
    ...
    <section id="why-us" classNameName="why-us">
      <div className="container" data-aos="fade-up">
        ...
        <div className="row g-0" data-aos="fade-up" data-aos-delay="200">
          ...
          <div className="col-xl-5 img-bg" style="background-image: url('assets/img/why-us-bg.jpg')"></div>
        ...
        <div className="row">
          ...
          <div className="col-lg-5 position-relative" data-aos="fade-up" data-aos-delay="200">
            <div className="phone-wrap">
              <img src="assets/img/iphone.png" alt="Image" className="img-fluid"></img>
            </div>
          </div>
        </div>
